/*
 * This code is taken from FreeBSD source code available at:
...
/*
 * This code is supplied by Antmicro.
 * Everything above this comment is taken excatly as it was in FreeBSD source code
 * (apart from includes and first comment explaining code origin).
 */
