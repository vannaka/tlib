...
{
    // TODO: Remove after providing AES_[i]sbox and AES_[i]shifts from crypto/aes.c (it's BSD or MIT)
    unimplemented();
...
{
    // TODO: Remove after providing sm4_sbox from 'crypto/sm4.c' (LGPL)
    unimplemented(); uint8_t *sm4_sbox;
