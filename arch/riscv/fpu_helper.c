...
uint64_t helper_fmadd_s(CPUState *env, uint64_t frs1, uint64_t frs2,
...
uint64_t helper_fmadd_d(CPUState *env, uint64_t frs1, uint64_t frs2,
                        uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fmsub_s(CPUState *env, uint64_t frs1, uint64_t frs2,
                        uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fmsub_d(CPUState *env, uint64_t frs1, uint64_t frs2,
                        uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fnmsub_s(CPUState *env, uint64_t frs1, uint64_t frs2,
                         uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fnmsub_d(CPUState *env, uint64_t frs1, uint64_t frs2,
                         uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fnmadd_s(CPUState *env, uint64_t frs1, uint64_t frs2,
                         uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fnmadd_d(CPUState *env, uint64_t frs1, uint64_t frs2,
                         uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fadd_s(CPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fsub_s(CPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fmul_s(CPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fdiv_s(CPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fadd_d(CPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fsub_d(CPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fmul_d(CPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fdiv_d(CPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
